...
test = pd.DataFrame(df2.iloc[4990:, :])

# test = pd.DataFrame(test.iloc[4000:,:])
...
model.load_state_dict(torch.load('/home/zahorack/Projects/code-against-hate/model', map_location=torch.device('cpu')))
print(model.eval())
